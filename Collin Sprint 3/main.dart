...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final passwordField = TextField(
      ...
      decoration: InputDecoration(
          contentPadding: EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
          hintText: "Password",
          errorText: failedLogin ? 'password incorrect' : null,
          border:
          OutlineInputBorder(borderRadius: BorderRadius.circular(32.0))),
    );
    ...
    final loginButton = Material(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          ...
          stringCheck(emailController.text, passwordController.text).then((String result){
            setState((){
              sCheck = result;
            });
          });
  ...
  Future<String> stringCheck(String username, String password) async {
    String response = "";
    try {
      String result = await platform.invokeMethod('checklogin', <String, String>{'address': username, 'pass': password});
